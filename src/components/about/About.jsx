    ...
    <section id="about">
      ...
      <div className="container about__container">
        ...
        <div className="about__me-content">
          ...
          <p>
           An enthusiastic and highly motivated Software Engineer with one year of experience in Cloud Native development. With a strong foundation in Java, Python, C++, and JavaScript, I am constantly seeking opportunities to expand my knowledge and skills. I have a deep passion for creating innovative solutions and thrive in dynamic and fast-paced environments.

If you are looking for a dedicated and adaptable team member who is willing to go the extra mile, I would be thrilled to connect and explore potential collaborations.
